import { StyleSheet, SafeAreaView, View, ScrollView, ImageBackground, TouchableOpacity, Text } from 'react-native'
...
const GuideDetailScreen = ({ route, navigation }: Props) => {
    ...
    const extraAttributes = additionalAttributes[place.name] || { entranceFee: "N/A", travelTips: [] };
